...
namespace ISD.DA
{
    public class DataAccessComponent
    {
        ...
        */
        ...
        public DataSetComponent.v_ActivityViewDataTable RetrieveProviderActivitiesFilteredReport(Guid ProviderID, string SearchKey, int ageFrom, int ageTo, int postCode, int CategoryID)
        {
        ...
        public DataSetComponent.UserImageDetailRow RetrieveProviderPrimaryImage(Guid providerID)
        {
            ISDEntities ent = new ISDEntities();
        ...
        public DataSetComponent.SponsorRow RetrieveSponsorDetails(Guid SponsorID)
        {
            ISDEntities ent = new ISDEntities();
            var query = from a in ent.Sponsor
                        where a.ID == SponsorID
        ...
        public void ValidateUserRewards(List<String> userList)
        {
            ...
            foreach (var userGUID in userWORewards)
            {
        ...
        */
        ...
        public DataSetComponent.v_ActivityExplorerDataTable RetrieveProviderActivitiesbySearchPhrase(Guid providerID, string stFrom, string stTo, string tmFrom, string tmTo, string searchKey, int ageFrom, int ageTo, string suburbID, int categoryID, int startIndex, int amount, string sortExpression, string MonFilter, string TueFilter, string WedFilter, string ThursFilter, string FriFilter, string SatFilter, string SunFilter)
        {
        ...
        //public DataSetComponent.v_ActivityViewDataTable RetrieveProviderActivitiesReportbySearchPhrase(Guid providerID, string stFrom, string stTo, string searchKey, string sortExpression)
        //{
        //    //splitting keywords as keyword can be a multiple words
        //    String[] Keywords = Array.ConvertAll(searchKey.Split(';'), c => c.Trim());
        ...
        public DataSetComponent.v_ActivityViewDataTable RetrieveProviderActivitiesReport(Guid providerID, string stFrom, string stTo, int categoryID, string sortExpression)
        {
            ISDEntities ent = new ISDEntities();
        ...
        public DataSetComponent.v_ActivityExplorerDataTable RetrieveProviderActivities(Guid providerID, string stFrom, string stTo, string tmFrom, string tmTo, int categoryID, int ageFrom, int ageTo, string suburbID, int startIndex, int amount, string sortExpression, string MonFilter, string TueFilter, string WedFilter, string ThursFilter, string FriFilter, string SatFilter, string SunFilter)
        {
            ISDEntities ent = new ISDEntities();
        ...
        //public DataSetComponent.v_ActivityExplorerDataTable RetrieveProviderActivities(Guid providerID, int categoryID, string sortExpression)
        //{
        //    ISDEntities ent = new ISDEntities();
        ...
        public DataSetComponent.v_ActivityViewDataTable RetrieveSearchProviderActivities(Guid providerID, String searchKey, int startIndex, int amount, string sortExpression)
        {
            //splitting keywords as keyword can be a multiple words
            String[] Keywords = Array.ConvertAll(searchKey.Split(';'), c => c.Trim());
        ...
        public DataSetComponent.v_ActivityViewDataTable RetrieveActivityViews(Guid providerID, int categoryID, int startIndex, int amount, string sortExpression)
        {
            ISDEntities ent = new ISDEntities();
            IQueryable<v_ActivityView> query = null;
            if (providerID != Guid.Empty && categoryID != 0)
        ...
        public DataSetComponent.v_ActivityViewDataTable RetrieveActivityViewsFromActivitiesIDArray(Guid providerID, int[] activitiesID, int startIndex, int amount, string sortExpression)
        {
            ISDEntities ent = new ISDEntities();
            IQueryable<v_ActivityView> query = null;
            if (providerID != Guid.Empty && categoryID != 0)
        ...
        public DataSetComponent.ActivityDataTable RetrieveActivities(Guid providerID, int categoryID, int startIndex, int amount, string sortExpression)
        {
            ISDEntities ent = new ISDEntities();
        ...
        */
        ...
        public Guid RetrieveUserGUID(string username)
        {
            ...
            if (query.FirstOrDefault() != null)
                return new Guid(query.FirstOrDefault().Id);
        ...
        public Guid RetrieveUserGUIDbyEmailAddress(string EmailAddress)
        {
            ...
            else
            {
                ...
                if (query.FirstOrDefault() != null)
                    return new Guid(query.FirstOrDefault().UserID);
                else
                {
                    ...
                    if (nextquery.FirstOrDefault() != null)
                        return new Guid(nextquery.FirstOrDefault().UserID);
                    else return Guid.Empty;
                }
            }
        }
        ...
        public void UpdateUserImageInformation(Guid userID, int iiID, DataSetComponent.UserImageRow dr)
        {
            ISDEntities ent = new ISDEntities();
        ...
        public DataSetComponent.UserImageRow RetrieveUserImageInformation(Guid userID)
        {
            ISDEntities ent = new ISDEntities();
        ...
        public DataSetComponent.UserImageDetailDataTable RetrieveUserImages(Guid userID)
        {
            ISDEntities ent = new ISDEntities();
        ...
        public DataSetComponent.UserImageDetailRow RetrievePrimaryProductImage(Guid userID)
        {
            ISDEntities ent = new ISDEntities();
        ...
        public DataSetComponent.UserImageDetailRow RetrieveProductMainImage(Guid userID)
        {
            ISDEntities ent = new ISDEntities();
        ...
        public DataSetComponent.UserImageDetailRow RetrieveUserImage(Guid userID, int imageID)
        {
            ISDEntities ent = new ISDEntities();
        ...
        {
            string strGuid = userID.ToString();
            ISDEntities ent = new ISDEntities();

            var query = from a in ent.UserSavedList
                        where a.OwnerGuid == strGuid && a.ListValue == actID
                        select a;
        ...
        public DataSetComponent.v_UserAttendanceViewDataTable RetrieveActAttendance(Guid userID)
        {
            ISDEntities ent = new ISDEntities();
        ...
        public DataSetComponent.v_RewardExplorerDataTable RetrieveAdminRewardsbySearchPhrase(Guid providerID, string searchKey, int ageFrom, int ageTo, string RewardType, int categoryID, int startIndex, int amount, string sortExpression)
        {
        ...
        public DataSetComponent.v_RewardExplorerDataTable RetrieveAdminRewardsbySearchPhrase(Guid providerID, string searchKey, string sortExpression)
        {
            String[] Keywords = Array.ConvertAll(searchKey.Split(';'), c => c.Trim());
        ...
        public DataSetComponent.v_RewardExplorerDataTable RetrieveAdminRewards(int categoryID, Guid providerID, int ageFrom, int ageTo, string RewardType, string sortExpression, int startIndex, int amount)
        {
        ...
        public DataSetComponent.v_RewardExplorerDataTable RetrieveAdminRewards(Guid providerID, int categoryID, string sortExpression)
        {
            ISDEntities ent = new ISDEntities();
        ...
        public DataSetComponent.v_ActivityExplorerDataTable RetrieveProviderActivitiesbySearchPhrase(Guid providerID, string searchKey, int startIndex, int amount, string sortExpression)
        {
            //splitting keywords as keyword can be a multiple words
            String[] Keywords = Array.ConvertAll(searchKey.Split(';'), c => c.Trim());
        ...
        public DataSetComponent.v_ActivityExplorerDataTable RetrieveProviderActivitiesbySearchPhrase(Guid providerID, string searchKey, string sortExpression)
        {
            //splitting keywords as keyword can be a multiple words
            String[] Keywords = Array.ConvertAll(searchKey.Split(';'), c => c.Trim());
        ...
        public DataSetComponent.v_ActivityViewDataTable RetrieveProviderActivitiesReportbySearchPhrase(Guid providerID, string searchKey, string sortExpression)
        {
            //splitting keywords as keyword can be a multiple words
            String[] Keywords = Array.ConvertAll(searchKey.Split(';'), c => c.Trim());
        ...
        public DataSetComponent.v_ActivityViewDataTable RetrieveProviderActivitiesReport(Guid providerID, int categoryID, string sortExpression)
        {
            ISDEntities ent = new ISDEntities();
        ...
        public DataSetComponent.v_ActivityViewDataTable RetrieveProviderActivitiesFilteredReport(Guid ProviderID, string SearchKey, int ageFrom, int ageTo, int postCode, int CategoryID, int startIndex, int amount, string sortExpression)
        {
        ...
        public DataSetComponent.v_ActivityExplorerDataTable RetrieveProviderActivities(Guid providerID, int categoryID, int startIndex, int amount, string sortExpression)
        {
            ISDEntities ent = new ISDEntities();
        ...
        public DataSetComponent.v_ActivityExplorerDataTable RetrieveProviderActivitiesbyCategoryID(Guid providerID, int categoryID, int startIndex, int amount, string sortExpression)
        {
            ISDEntities ent = new ISDEntities();
            IQueryable<v_ActivityExplorer> query = null;
            if (providerID != Guid.Empty && categoryID != 0)
