    ...
    public partial class ActivityListing : System.Web.UI.UserControl
    {
        ...
        protected void ApplySidebarFilter(int categoryID, int ageFrom, int ageTo, string suburbID, DateTime dtFrom, DateTime dtTo, TimeSpan tmFrom, TimeSpan tmTo, ListItemCollection filteredDays, bool filtered)
        {
            ...
            if (string.IsNullOrEmpty(SearchKey))
                Response.Redirect("~/Activities/Default.aspx?" + SystemConstants.CategoryID + "=" + categoryID + "&" + SystemConstants.StartRow + "=" + StartRow + "&" + SystemConstants.SortValue + "=" + SortValue + "&" + SystemConstants.PageSize + "=" + PageSize + "&" + SystemConstants.AgeFrom + "=" + ageFrom + "&" + SystemConstants.AgeTo + "=" + ageTo + "&" + SystemConstants.DateFrom + "=" + dtFrom + "&" + SystemConstants.DateTo + "=" + dtTo + "&" + SystemConstants.TimeFrom + "=" + tmFrom + "&" + SystemConstants.TimeTo + "=" + tmTo + "&" + SystemConstants.SuburbID + "=" + suburbID + daysFilter + "&" + SystemConstants.Filtered + "=" + filtered);
            else
                Response.Redirect("~/Activities/Default.aspx?" + SystemConstants.SearchKey + "=" + SearchKey + "&" + SystemConstants.CategoryID + "=" + categoryID + "&" + SystemConstants.StartRow + "=" + StartRow + "&" + SystemConstants.SortValue + "=" + SortValue + "&" + SystemConstants.PageSize + "=" + PageSize + "&" + SystemConstants.AgeFrom + "=" + ageFrom + "&" + SystemConstants.AgeTo + "=" + ageTo + "&" + SystemConstants.DateFrom + "=" + dtFrom + "&" + SystemConstants.DateTo + "=" + dtTo + "&" + SystemConstants.TimeFrom + "=" + tmFrom + "&" + SystemConstants.TimeTo + "=" + tmTo + "&" + SystemConstants.SuburbID + "=" + suburbID + daysFilter + "&" + SystemConstants.Filtered + "=" + filtered);
        ...
        protected void RefreshActivitiesSection(int ID, int startRow, string sortBy, int pageSize, string searchKey, DateTime dtFrom, DateTime dtTo, int ageFrom, int ageTo,
            string suburbID, bool monFilter, bool tueFilter, bool wedFilter, bool thuFilter, bool friFilter, bool satFilter, bool sunFilter, bool filtered)
        {
            String daysFilter = "";

            if (!monFilter && !tueFilter && !wedFilter && !thuFilter && !friFilter && !satFilter && !sunFilter)
            {
                if (monFilter)
                    daysFilter += "&" + SystemConstants.MondayisFiltered + "=1";
                if (tueFilter)
            ...
            if (string.IsNullOrEmpty(searchKey))
                Response.Redirect("~/Activities/Default.aspx?" + SystemConstants.CategoryID + "=" + CategoryID + "&" + SystemConstants.StartRow + "=" + startRow + "&" +
                    SystemConstants.SortValue + "=" + sortBy + "&" + SystemConstants.PageSize + "=" + pageSize + "&" + SystemConstants.AgeFrom + "=" + ageFrom + "&" +
                    SystemConstants.AgeTo + "=" + ageTo + "&" + SystemConstants.DateFrom + "=" + dtFrom + "&" + SystemConstants.DateTo + "=" + dtTo + "&" +
                    SystemConstants.TimeFrom + "=" + tmFrom + "&" + SystemConstants.TimeTo + "=" + tmTo + "&" + SystemConstants.SuburbID + "=" + suburbID + daysFilter + "&" +
                    SystemConstants.Filtered + "=" + filtered);
            else
                Response.Redirect("~/Activities/Default.aspx?" + SystemConstants.SearchKey + "=" + SearchKey + "&" + SystemConstants.CategoryID + "=" + CategoryID + "&" +
                    SystemConstants.StartRow + "=" + startRow + "&" + SystemConstants.SortValue + "=" + sortBy + "&" + SystemConstants.PageSize + "=" + pageSize + "&" +
                    SystemConstants.AgeFrom + "=" + ageFrom + "&" + SystemConstants.AgeTo + "=" + ageTo + "&" + SystemConstants.DateFrom + "=" + dtFrom + "&" +
                    SystemConstants.DateTo + "=" + dtTo + "&" + SystemConstants.TimeFrom + "=" + tmFrom + "&" + SystemConstants.TimeTo + "=" + tmTo + "&" +
                    SystemConstants.SuburbID + "=" + suburbID + daysFilter + "&" + SystemConstants.Filtered + "=" + filtered);
