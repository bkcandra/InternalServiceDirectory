...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <div>
            ...
            <asp:ListView ID="ListViewActLog" runat="server" OnItemCommand="ListViewActLog_ItemCommand" OnItemDataBound="ListViewActLog_ItemDataBound">
                <LayoutTemplate>
            ...
            <asp:ListView ID="ListViewLogAction" runat="server" OnItemCommand="ListViewLogAction_ItemCommand" OnItemDataBound="ListViewLogAction_ItemDataBound">
                <LayoutTemplate>
