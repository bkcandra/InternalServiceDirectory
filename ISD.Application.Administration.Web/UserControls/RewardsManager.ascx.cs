...
namespace ISD.Administration.Web.UserControls
{
    public partial class RewardsManager : System.Web.UI.UserControl
    {
        ...
        {
            var Rewards = new DataAccessComponent().RetrieveRewardsExplorer();
        ...
        protected void rptRewards_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                hlnkSponsorName.NavigateUrl = "~/Rewards/SponsorTools.aspx?" + SystemConstants.route_SponsorsID + "=" + hdnProviderID.Value;
                Label lblsponsor = e.Item.FindControl("lblsponsor") as Label;
                DataAccessComponent dac = new DataAccessComponent();
                lblsponsor.Text = dac.getSponsorName(hdnProviderID.Value);
                ...
                hlnkRewardsName.NavigateUrl = "~/Rewards/Modify.aspx?" + SystemConstants.route_RewardsID + "=" + hdnRewardsID.Value;
        ...
        protected void lnkDelete_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Count != 0)
            {
                new BusinessFunctionComponent().DeleteRewards(dt);
            }
            Refresh();
        }
