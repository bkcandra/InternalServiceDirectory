    ...
    public partial class ActivityRegistrationCategory : System.Web.UI.UserControl
    {
        ...
        */
        ...
        private void InitiateCategory()
        {
            ...
            DataSetComponent.CategoryDataTable dt = new DataAccessComponent().RetrieveLv0Categories();
            SortListItem(dt);
        ...
        private void SortListItem(DataSetComponent.CategoryDataTable dt)
        {

            string catName = "";
            int catVal = 0;
            var drRemove = dt.NewCategoryRow();
            ...
            {
                dt.RemoveCategoryRow(drRemove);
                var drLast = dt.NewCategoryRow();
                drLast.Name = catName;
                drLast.ID = catVal;
                dt.AddCategoryRow(drLast);
            }
        }
        ...
        {
            DataSetComponent.CategoryDataTable dt = new DataAccessComponent().RetrieveLv1Categories(RootCat);
            SortListItem(dt);
        ...
        {
            DataSetComponent.CategoryDataTable dt = new DataAccessComponent().RetrieveLv1Categories(Lvl1Cat);
            SortListItem(dt);
            listViewCatLvl2.Items.Clear();
            if (dt.Count() != 0)
            {
