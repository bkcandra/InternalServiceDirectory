...
namespace ISD.Administration.Web.UserControls
{
    public partial class CategoriesSetupUC : System.Web.UI.UserControl
    {
        ...
        public DataSetComponent.CategoryRow GetData()
        {
        ...
        //public void SetData(DataSetComponent.BrandRow dr)
        //{
        ...
        internal void SetData(DataSetComponent.CategoryRow dr)
        {
            SetDDL();
            hdnCategoryID.Value = dr.ID.ToString();
            ...
            if (Mode == SystemConstants.FormMode.Edit)
            {
                ...
                dt = new DataAccessComponent().RetrieveAllCategories();
                ...
                bool find = false;
                foreach (DataSetComponent.CategoryRow brandDR in dt.Rows)
                {
        ...
        protected void lnkEdit_Click(object sender, EventArgs e)
        {
            if (Mode != SystemConstants.FormMode.Edit)
            {
                ...
                hdnCategoryID.Value = new DataAccessComponent().RetrieveLastCategoryID();
            }
