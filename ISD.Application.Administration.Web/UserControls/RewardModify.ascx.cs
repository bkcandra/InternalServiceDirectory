...
namespace ISD.Administration.Web.UserControls
{
    public partial class RewardModify : System.Web.UI.UserControl
    {
        ...
        {
            var dr = new DataAccessComponent().RetrieveRewardInfo(RewardID);
            if (dr != null)
            {
                ...
                if (!string.IsNullOrEmpty(check))
                {
                    ...
                    {
                        var dri = new DataAccessComponent().RetrieveRewardPrimaryImage(Convert.ToInt32(RewardID));
        ...
        protected void lnkUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (dr != null)
            {
                ...
                new BusinessFunctionComponent().UpdateRewards(dr, drDet, drt);
                SetRewardInformation();    
        ...
        private DataSetComponent.RewardImageRow GetImgDetails()
        {
            ...
            if (fileUpRewardImage.HasFile)
            {
                ...
                dr.ID = new DataAccessComponent().getImageID(RewardID);
        ...
        public DataSetComponent.RewardsDetailsRow GetRwrdDetails()
        {
            ...
            dt.ID = new DataAccessComponent().getDetailsID(RewardID);
