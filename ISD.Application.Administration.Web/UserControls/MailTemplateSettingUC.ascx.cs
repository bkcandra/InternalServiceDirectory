...
namespace ISD.Administration.Web.UserControls
{
    public partial class MailTemplateSettingUC : System.Web.UI.UserControl
    {
        ...
        private DataSetComponent.EmailSettingDataTable GetEmailSetting()
        {
            var dt = new DataSetComponent.EmailSettingDataTable();

            var dr1 = dt.NewEmailSettingRow();
            ...
            dr1.ModifiedBy = Context.User.Identity.Name;
            dt.AddEmailSettingRow(dr1);

            var dr2 = dt.NewEmailSettingRow();
            ...
            dr2.ModifiedBy = Context.User.Identity.Name;
            dt.AddEmailSettingRow(dr2);

            var dr3 = dt.NewEmailSettingRow();
            ...
            dr3.ModifiedBy = Context.User.Identity.Name;
            dt.AddEmailSettingRow(dr3);

            var dr4 = dt.NewEmailSettingRow();
            ...
            dr4.ModifiedBy = Context.User.Identity.Name;
            dt.AddEmailSettingRow(dr4);

            var dr5 = dt.NewEmailSettingRow();
            ...
            dr5.ModifiedBy = Context.User.Identity.Name;
            dt.AddEmailSettingRow(dr5);

            var dr6 = dt.NewEmailSettingRow();
            ...
            dr6.ModifiedBy = Context.User.Identity.Name;
            dt.AddEmailSettingRow(dr6);

            var dr7 = dt.NewEmailSettingRow();
            ...
            dr7.ModifiedBy = Context.User.Identity.Name;
            dt.AddEmailSettingRow(dr7);


            var dr8 = dt.NewEmailSettingRow();
            ...
            dr8.ModifiedBy = Context.User.Identity.Name;
            dt.AddEmailSettingRow(dr8);
            return dt;
        }
        ...
        protected void lnkSave_Click(object sender, EventArgs e)
        {
            ...
            new DataAccessComponent().SaveEmailSettings(dt);
