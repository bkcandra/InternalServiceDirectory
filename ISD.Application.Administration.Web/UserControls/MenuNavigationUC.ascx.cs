...
namespace ISD.Administration.Web.UserControls
{
    public partial class MenuNavigationUC : System.Web.UI.UserControl
    {
        ...
        {
            DataSetComponent.v_MenuDataTable dt = new DataAccessComponent().RetrieveMenuExplorers((int)SystemConstants.MenuType.MemberMenu);
        ...
        private void SetTarget()
        {
            ...
            {
                DataSetComponent.ProviderProfilesDataTable dt = new DataAccessComponent().RetrieveAllproviders();
                if (dt.Count == 0)
                {
            ...
            {
                DataSetComponent.ActivityDataTable dt = new DataAccessComponent().RetrieveActivities();
                if (dt.Count == 0)
                {
            ...
            {
                DataSetComponent.PageDataTable dt = new DataAccessComponent().RetrievePages();
                if (dt.Count == 0)
                {
        ...
        protected void lnkOk_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DataSetComponent.v_MenuRow dr = GetData();
        ...
        private DataSetComponent.v_MenuRow GetData()
        {
        ...
        {
            var dr = new DataAccessComponent().RetrieveMenuExplorer(ID);
            if (dr == null)
            {
                lblWarning.Visible = false;
                if (ID == 0)
        ...
        protected void lnkOkProvider_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DataSetComponent.v_MenuRow dr = GetDataProvider();
        ...
        private DataSetComponent.v_MenuRow GetDataProvider()
        {
            DataSetComponent.v_MenuRow dr = new DataSetComponent.v_MenuDataTable().Newv_MenuRow();
