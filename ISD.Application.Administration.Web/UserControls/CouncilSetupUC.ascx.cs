...
namespace ISD.Administration.Web.UserControls
{
    public partial class CouncilSetupUC : System.Web.UI.UserControl
    {
        ...
        public void SetDDL()
        {
            var dt = new DataAccessComponent().RetrieveStates();
            if (dt.Count != 0)
            {
        ...
        public void SetData(DataSetComponent.CouncilRow dr)
        {
        ...
        protected void lnkOk1_Click(object sender, EventArgs e)
        {
            ...
            {
                DataSetComponent.CouncilRow dr = new DataSetComponent.CouncilDataTable().NewCouncilRow();
                dr = GetData();
        ...
        public DataSetComponent.CouncilRow GetData()
        {
            DataSetComponent.CouncilRow dr = new DataSetComponent.CouncilDataTable().NewCouncilRow();
