...
namespace ISD.Administration.Web.UserControls
{
    public partial class MailTemplateDetailUC : System.Web.UI.UserControl
    {
        ...
        private void SetData(DataSetComponent.EmailTemplateRow dr)
        {
        ...
        protected void lnkSave_Click(object sender, EventArgs e)
        {
            ...
            if (Mode == UIMode.Create)
            {
                new DataAccessComponent().CreateEmailTemplate(dr);
                TemplateID = dr.ID;
            }
            else if (Mode == UIMode.Edit)
                new DataAccessComponent().UpdateEmailTemplate(dr);
            Refresh();
        }

        private DataSetComponent.EmailTemplateRow GetData()
        {
            DataSetComponent.EmailTemplateRow dr = new DataSetComponent.EmailTemplateDataTable().NewEmailTemplateRow();
