...
namespace HealthyClub.Administration.Web.UserControls
{
    public partial class ActivityImageListView : System.Web.UI.UserControl
    {
        ...
        {
            var dt = new DataAccessComponent().RetrieveActivityImages(ActivityID);
        ...
        protected void DataList1_ItemDataBound(object sender, DataListItemEventArgs e)
        {
            ...
            hlnkImage.NavigateUrl = new BusinessFunctionComponent().RetrieveImageUrl(ActivityID, Convert.ToInt32(hdnImageID.Value));
