...
namespace HealthyClub.Administration.Web.UserControls
{
    public partial class WebMailConfigUC : System.Web.UI.UserControl
    {
        ...
        {
            var dr = new DataAccessComponent().RetrieveEmailer();
            if (dr != null)
            {
        ...
        private void SetEmailerInformation(DataSetComponent.WebConfigurationRow dr)
        {
        ...
        private DataSetComponent.WebConfigurationRow GetData()
        {
