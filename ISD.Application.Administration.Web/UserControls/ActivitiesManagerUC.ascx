<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ActivitiesManagerUC.ascx.cs" Inherits="ISD.Administration.Web.UserControls.ActivitiesManagerUC" %>
...
<span>
    ...
    <asp:Button CssClass="btn btn-grey" ID="btnCheckReference" runat="server" Text="Check activities reference codes" OnClick="btnCheckReference_Click"></asp:Button>
