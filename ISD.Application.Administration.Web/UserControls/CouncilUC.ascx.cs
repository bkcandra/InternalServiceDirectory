...
namespace HealthyClub.Administration.Web.UserControls
{
    public partial class CouncilUC : System.Web.UI.UserControl
    {
        ...
        protected void lnkDelete_Click(object sender, EventArgs e)
        {
            ...
            DataSetComponent.CouncilDataTable dt = GetSelected();
            foreach (DataSetComponent.CouncilRow dr in dt)
            {
        ...
        private DataSetComponent.CouncilDataTable GetSelected()
        {
