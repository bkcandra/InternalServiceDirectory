...
namespace ISD.Administration.Web.UserControls
{
    public partial class SuburbSetup : System.Web.UI.UserControl
    {
        ...
        public void SetData(DataSetComponent.v_SuburbExplorerRow dr)
        {
            SetDDL();
        ...
        private void SetDDL()
        {
            DataSetComponent.CouncilDataTable dt = new DataAccessComponent().RetrieveCouncils();
            if (dt.Count != 0)
            {
        ...
        {
            DataSetComponent.SuburbRow dr = new DataSetComponent.SuburbDataTable().NewSuburbRow();
            dr = GetData();
        ...
        public DataSetComponent.SuburbRow GetData()
        {
            DataSetComponent.SuburbRow dr = new DataSetComponent.SuburbDataTable().NewSuburbRow();
        ...
        protected void ddlCouncil_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                var councilDr = new DataAccessComponent().RetrieveCouncilState(Convert.ToInt32(ddlCouncil.SelectedValue));
