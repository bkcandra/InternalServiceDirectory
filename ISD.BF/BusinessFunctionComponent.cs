...
namespace ISD.BF
{
    public class BusinessFunctionComponent
    {
        ...
        public void ParseEmail(DataSetComponent.v_EmailExplorerRow emTemp, String userID, string token, int EmailTemplateType, int activityID)
        {
        ...
        public int getProviderPrimaryImage(String providerID)
        {
            ...
            var dt = dac.RetrieveUserImages(new Guid(providerID));
        ...
        public void CreateNewUserImage(Guid userID, DataSetComponent.UserImageRow userImage, DataSetComponent.UserImageDetailDataTable userImageDetail)
        {
            DataAccessComponent dac = new DataAccessComponent();
            userImage.UserID = userID;
        ...
        public void AddNewProviderImages(Guid ProviderID, DataSetComponent.UserImageDetailDataTable dt, DataSetComponent.UserImageRow usrImagDet)
        {
            DataAccessComponent dac = new DataAccessComponent();
        ...
        public IEnumerable<VisitorRecords> RetrieveProviderVisitorMontlyCount(Guid ProviderID, DateTime From, DateTime To, out int VisitCount)
        {
            DataAccessComponent dac = new DataAccessComponent();
