...
namespace ISD.User.Web.UserControls
{
    public partial class CustomerAccountUC : System.Web.UI.UserControl
    {
        ...
        {
            var dr = new DataAccessComponent().RetrieveUserProfiles(UserID.ToString());
            if (dr != null)
            {
                hdnID.Value = dr.UserID;
        ...
        private bool authUser()
        {
            ...
            {
                UserID = IdentityHelper.GetUserIdFromRequest(Request);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (!isError())
            {
                ...
                user.Email = txtEmailAdress.Text;
        ...
        private DataSetComponent.UserProfilesRow GetRegistrationData()
        {
            ...
            dr.ModifiedBy = IdentityHelper.GetProviderNameFromRequest(Request);;
