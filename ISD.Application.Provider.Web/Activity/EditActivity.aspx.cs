...
namespace HealthyClub.Providers.Web.Activity
{
    public partial class EditActivity : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (isNotValid)
            {
                ...
                */
                ...
                BusinessFunctionComponent.UpdateActivity(ActivityID, drDetail, contactDetails, drActGrouping, dtActSchedule);
        ...
        {
            new DataAccessComponent().ChangeStatus(ActivityID, (int)SystemConstants.ActivityStatus.NotActive, Context.User.Identity.Name);
            InitActivityInformation();
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (ActivityID != 0 || ActivityID != -1)
            {
                ...
                new DataAccessComponent().ChangeStatus(ActivityID, (int)SystemConstants.ActivityStatus.Deleting, Username);
            }
            InitActivityInformation();
        }
    }
