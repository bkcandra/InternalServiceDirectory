...
<ContentTemplate>
    ...
    <div style="text-align: right; width: 920px;">
        <asp:Button ID="BtnDelete" runat="server" Text="Delete" OnClick="btnDelete_Click" CssClass="buttonCreateAct" OnClientClick="return confirm('Are you sure you want to delete this activity?  Once you have deleted an activity it will be removed in three days.')" />
