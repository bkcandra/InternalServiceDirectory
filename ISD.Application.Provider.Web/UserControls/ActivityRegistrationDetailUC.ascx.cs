...
namespace HealthyClub.Providers.Web.UserControls
{
    public partial class ActivityRegistrationDetailUC : System.Web.UI.UserControl
    {
        ...
        private void setProviderData(DataSetComponent.ProviderProfilesRow dr)
        {
        ...
        public void SetActivityInformation()
        {
            if (EditMode)
            {
                ...
                var drProvider = new DataAccessComponent().RetrieveProviderProfiles((hdnProviderUsername.Value));
        ...
        {
            hdnProviderUsername.Value = Context.User.Identity.Name;
        }
        ...
        protected void chkUseProvider_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                var dr = new DataAccessComponent().RetrieveProviderProfiles((hdnProviderUsername.Value));
                setProviderData(dr);
                txtFirstName.Focus();
            }
            else
        ...
        public DataSetComponent.ActivityRow getDetails()
        {
            var dr = new DataSetComponent.ActivityDataTable().NewActivityRow();

            dr.Name = txtActivityName.Text;
            dr.ActivityCode = txtActivityName.Text;
            dr.Website = txtWebsite.Text;
            dr.CreatedBy = dr.ModifiedBy = Context.User.Identity.Name;
        ...
        public DataSetComponent.ActivityContactDetailRow getContactDetail()
        {
            DataSetComponent.ActivityContactDetailRow dr = new DataSetComponent.ActivityContactDetailDataTable().NewActivityContactDetailRow();

            dr.Title = Convert.ToInt32(ddlTitle.SelectedValue);
            dr.Username = Context.User.Identity.Name;
