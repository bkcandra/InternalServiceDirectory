...
namespace HealthyClub.Providers.Web.UserControls
{
    public partial class ActivityRegistrationTimetableUC : System.Web.UI.UserControl
    {
        ...
        public DataSetComponent.ActivityScheduleGridDataTable timeTableDT
        {
            get;
            set;
        }

        public DataSetComponent.ActivityScheduleDetailDataTable ExceptionDT
        {
            get;
            set;
        }

        public DataSetComponent.ActivityScheduleDataTable ScheduleDT
        {
            get;
            set;
        }
        ...
        public void initTimetable()
        {
            ...
            if (dr != null)
            {
                ...
                else
                {
                    if (EditMode)
                    {
                        ScheduleDT = new DataAccessComponent().RetrieveActivitySchedules(ActivityID);
                    }
        ...
        //private DataSetComponent.ActivityScheduleDetailDataTable GetSelected()
        //{
        //    DataSetComponent.ActivityScheduleDetailDataTable dt = new DataSetComponent.ActivityScheduleDetailDataTable();
        ...
        //            var dr = dt.NewActivityScheduleDetailRow();
        ...
        //                dt.AddActivityScheduleDetailRow(dr);
        //            }
        //        }
        //    }
        //    return dt;
        ...
        //public DataSetComponent.ActivityScheduleGridDataTable GetTimetablePreview(bool checkDelete)
        //{
        //    DataSetComponent.ActivityScheduleGridDataTable dt = new DataSetComponent.ActivityScheduleGridDataTable();
        //    foreach (GridViewRow row in gridviewPreview.Rows)
        //    {
        //        if (row.RowType == DataControlRowType.DataRow)
        //        {
        ...
        //    if (ScheduleDT != null)
        //    {
        //        timeTableDT = new BusinessFunctionComponent().CalculateRecurrence(ScheduleDT);
        ...
        public DataSetComponent.ActivityScheduleRow getTimetableInput()
        {
            if (ScheduleDT == null)
                ScheduleDT = new DataSetComponent.ActivityScheduleDataTable();
            var drShced = ScheduleDT.NewActivityScheduleRow();
        ...
        public DataSetComponent.ActivityScheduleDataTable getTimetable(bool checkDelete)
        {
            ScheduleDT = new DataSetComponent.ActivityScheduleDataTable();
            foreach (GridViewRow row in gridviewTimetable.Rows)
            {
                ...
                if (checkDelete)
                {
                    ...
                    {
                        var dr = ScheduleDT.NewActivityScheduleRow();
                        ...
                        ScheduleDT.AddActivityScheduleRow(dr);
                    }
                }
                else
                {
        ...
        protected void gridviewTimetable_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                int index = 0;
                DataRowView drView = e.Row.DataItem as DataRowView;
                DataSetComponent.ActivityScheduleRow dr = drView.Row as DataSetComponent.ActivityScheduleRow;
        ...
        {
            if (timeTableDT == null)
                timeTableDT = new DataSetComponent.ActivityScheduleGridDataTable();
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (infoIsValid())
            {
                ...
                else
                {
                    ...
                    ScheduleDT.AddActivityScheduleRow(aSched);
                    SetScheduleDataSource();
                    //SetTimetableDataSource();
                    SetTimetablePreview();
