    ...
    public partial class ActivityRegistrationDescription : System.Web.UI.UserControl
    {
        ...
        */
        private void setActivityDescription()
        {
            ...
            if (dr.CategoryID != 0)
            {
                var Cat = new DataAccessComponent().RetrieveCategory(dr.CategoryID);
                ListItem cat1 = new ListItem(Cat.Name, Cat.ID.ToString());
                SelectedCat.Add(cat1);
            }
            if (dr.SecondaryCategoryID1 != 0)
            {
                var Cat = new DataAccessComponent().RetrieveCategory(dr.SecondaryCategoryID1);
            ...
            {
                var Cat = new DataAccessComponent().RetrieveCategory(dr.SecondaryCategoryID2);
                ListItem cat3 = new ListItem(Cat.Name, Cat.ID.ToString());
                SelectedCat.Add(cat3);
            }
            if (dr.SecondaryCategoryID3 != 0)
            {
                var Cat = new DataAccessComponent().RetrieveCategory(dr.SecondaryCategoryID3);
            ...
            {
                var Cat = new DataAccessComponent().RetrieveCategory(dr.SecondaryCategoryID4);
        ...
        public DataSetComponent.ActivityRow getDetails(DataSetComponent.ActivityRow dr)
        {
